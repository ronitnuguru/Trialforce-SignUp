...
import createSignupTrial from "@salesforce/apex/TrialforceSignupController.createSignupTrial";

export default class TrialforceSignup extends NavigationMixin(LightningElement) {

    @api header;
    @api buttonLabel;
    @api displayQuickAction;
    @api quickActionLabel;
    @api quickActionURL;
    @api templateId;
    @api trialDays;
    @api displayCountry;
    ...
    handleSuccessSignup(email, company) {
        ...
        this.dispatchEvent(
            new ShowToastEvent({
                title: `Trial for ${company} was created`,
